...
/**
 * Observer called after saving customer
 */
class CustomerSaveAfterObserver implements \Magento\Framework\Event\ObserverInterface
{
    /**
    ...
    /**
     * Observer called when customer is saved
     *
    ...
    public function execute(
        ...
        try {
            if (!empty($customer)) {
                ...
                $getSynced = $customer->getNetsuiteSynced();
