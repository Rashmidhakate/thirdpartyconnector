...
use Zoku\NetSuiteConnector\Api\ProductGridRepositoryInterface as ProductGridRepositoryInterface;
use Zoku\NetSuiteConnector\Api\Data\ProductGridSearchResultInterfaceFactory;
use Zoku\NetSuiteConnector\Model\ResourceModel\ProductGrid\CollectionFactory;

/**
 * Product Log Grid repository
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class ProductGridRepository implements ProductGridRepositoryInterface
{
    /**
     ...
     * @param ProductGridSearchResultInterfaceFactory $productGridSearchResults
     * @param ResourceModel\ProductGrid\CollectionFactory $productGridCollection
     * @param CollectionProcessorInterface|null $collectionProcessor
     */
    public function __construct(
        ResourceModel\ProductGrid $productGridResource,
        ProductGridFactory $productGridFactory,
        ProductGridSearchResultInterfaceFactory $productGridSearchResults,
        CollectionFactory $productGridCollection,
