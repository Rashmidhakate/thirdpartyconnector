...
use Zoku\NetSuiteConnector\Api\OrderGridRepositoryInterface as OrderGridRepositoryInterface;
use Zoku\NetSuiteConnector\Api\Data\OrderGridSearchResultInterfaceFactory;
use Zoku\NetSuiteConnector\Model\ResourceModel\OrderGrid\CollectionFactory;

/**
 * Order Log Grid Repository
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class OrderGridRepository implements OrderGridRepositoryInterface
{
    /**
    ...
    public function __construct(
        ResourceModel\OrderGrid $orderGridResource,
        OrderGridFactory $orderGridFactory,
        OrderGridSearchResultInterfaceFactory $orderGridSearchResults,
